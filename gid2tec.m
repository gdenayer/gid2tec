...
for ires=1:nressection
    ...
    if outputQuantity_step > outputQuantity_step_old
        ...
        if (nbquantityperstep>0)
            ...
            writeData2plt(nameFileMshInfo,outputQuantity_step_old, ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function writeData2plt(nameFileMshInfo,outputQuantity_step_old, ...
    outputQuantity,headersMsh_Nnode,num_nodes, ...
    num_elements,msh,nbquantityperstep)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if headersMsh_Nnode == 3
    header_tecplot=strcat('TITLE = "msh2plt file"\n VARIABLES = "X" "Y" "Z"'," ", ...
        list_tecplot_var,"\n ", ...
...
fprintf(fileID, header_tecplot,num_nodes,num_elements);
%
